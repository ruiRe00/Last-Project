...
// Check if user is airline and has airline_id
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'airline' || !isset($_SESSION['airline_id'])) {
    $_SESSION['error'] = "Please login as an airline to access this page.";
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $stmt = $pdo->prepare("SELECT b.*, u.username, f.flight_number, f.price, 
                        ...
                        while ($transaction = $stmt->fetch()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong><?php echo htmlspecialchars($transaction['flight_number']); ?></strong><br>
...
<script>
function viewBookingDetails(bookingNumber, username, flightNumber, route, schedule, amount, status, proof, bookingDate) {
